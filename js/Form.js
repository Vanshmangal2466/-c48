...
for(var i in d1){
    ...
    this.SUBMIT.position(550,550);
    this.SUBMIT.mousePressed(()=>{
if(this.input1.value()===f1[0]){
    score++;
}
if(this.input2.value()===f1[1]){
    score++;
}
if(this.input3.value()===f1[2]){
    score++;
}
if(this.input4.value()===f1[3]){
    score++;
}
if(this.input5.value()===f1[4]){
    score++;
}
gamestate=3;
